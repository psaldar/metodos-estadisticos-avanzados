...
for y in years:
    dic_cruces[y]['Desempleo'] = desempleo['Tasa de desempleo (%)'][desempleo['Year']==str(y)].mean()
...
estos_years =  ['2016 (pr)', '2017 (pr)', '2018 (pr)']
voyen = 0
for y in years:
    dic_cruces[y]['Balance_Fiscal'] = bal_fiscal['DEFICIT (-) O SUPERAVIT (+)'][bal_fiscal['Year']==estos_years[voyen]].values[0]
    voyen = voyen+1
