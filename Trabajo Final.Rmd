...
```{r}
p3 = grafica(data_aux, "Costo.de.ventas" , "Costo.de.ventas_dif")
```
...
empresas_test = c(830037495, 830052054,
                   860009694, 860033653,
                   860501682, 890117431,
                   890300012, 890929951,
                   900173460, 900184722,
...
#mod_me = lmer('Costo.de.ventas_dif~TRM+(TRM|NIT)', data = data_train_z)
```
