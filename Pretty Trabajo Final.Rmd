...
En la siguiente tabla, vemos información descriptiva de las variables que se considerarán en la etapa de modelamiento del trabajo, vemos así que contamos con un 6 posibles variables respuesta y 7 variables explicativas
, cada una con magnitudes diferentes. Esto nos permite tener una idea inicial de las características del conjunto de datos.
