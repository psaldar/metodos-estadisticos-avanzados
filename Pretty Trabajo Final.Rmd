...
Los valores para las variables macroeconómicas (variables explicativas) se extrajeron del Banco de la República y de el DANE. Se descargaron archivos de Excel para cada una de las variables macro. 
